...
import 'package:skillsture_project/constants/constants.dart';

import '../../navigation/navigation.dart';

class SecondCourseItemSelected extends StatefulWidget {
  const SecondCourseItemSelected({Key? key}) : super(key: key);

  @override
  State<SecondCourseItemSelected> createState() => _SecondCourseItemSelectedState();
}

class _SecondCourseItemSelectedState extends State<SecondCourseItemSelected> {
