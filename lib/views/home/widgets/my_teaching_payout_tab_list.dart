...
class MyTeachingPayoutTabList extends StatelessWidget {
  final TeachingScheduleLiveStreamModel liveStreamModel;
  const MyTeachingPayoutTabList({Key? key, required this.liveStreamModel}) : super(key: key);
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      liveStreamModel.liveStreamPaymentCode,
                      style: TextStyle(
                          fontSize: 17,
